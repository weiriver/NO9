      ...
      <div slot="TableSlot">
        <Table stripe :data="tableData" :height="tableHeight" border style="width: 100%" v-if="tableHeight">
          ...
          <TableColumn
             ...
             width="210">
            <template slot-scope="scope">
              <Button @click="dialogVisible = true" type="text" typeOptions>催办</Button>
              <Button @click="dialogVisible = true" type="text" typeOptions>强制结束</Button>
              <Button @click="dialogVisible = true" type="text" typeOptions>查看</Button>
            </template>
          </TableColumn>
        </Table>
      </div>
