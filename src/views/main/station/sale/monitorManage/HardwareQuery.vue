    ...
    <TablePage :totalCount="totalCount">
      ...
      <div slot="query">
        ...
        <Form :inline="true" class="form-inline" label-width="140px" :model="searchForm" size="mini"
          ...
          <FormItem label="投注机型号" prop="termType">
            <Input v-model="searchForm.termType"></Input>
          </FormItem>
      ...
      <div slot="TableSlot">
        <Table stripe :data="tableData" :height="tableHeight" border style="width: 100%" v-if="tableHeight">
          ...
          <TableColumn label="投注机型号" prop="termType"></TableColumn>
          <TableColumn label="主板型号" prop="mainBoardType"></TableColumn>
          <TableColumn label="打印机主板型号" prop="printerType"></TableColumn>
          <TableColumn label="阅读器型号" prop="readerType"></TableColumn>
          <TableColumn label="键盘型号" prop="keyBoardType"></TableColumn>
          <TableColumn label="终端整机条码" prop="terminalCode"></TableColumn>
          <TableColumn label="CPU主频" prop="cpuFreq"></TableColumn>
          ...
          <TableColumn
                  ...
                  width="100">
            <template slot-scope="scope">
              <Button @click="toDetail(scope.row.stationID, scope.row.termType)" type="text" typeOptions>查看硬件信息</Button>
            </template>
          </TableColumn>
        </Table>
  ...
  export default {
    ...
    methods: {
      ...
      async query() {
        ...
        this.tableData = res.content.terminalHardInfo
